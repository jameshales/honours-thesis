...
quantified modal logics}. We consider refinement quantified versions of
multi-agent modal, doxastic and epistemic logics. We provide an axiomatisation
for the refinement quantified modal and doxastic logics, and show that they are
decidable, and give an upper-bound for the complexity of the logics. We also
provide a translation from the refinement quantified epistemic logic to the
refinement quantified doxastic logic, which gives us similar decidability and
complexity results.
